...
To add external links to the navigation, add them to the `nav_external_links` [configuration]({% link docs/generic_json_schema.md %}) option in your site's `_config.yml` file.
